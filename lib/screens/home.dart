...
import 'package:helloworld/Models/categories/CategoryModel.dart';
import 'package:helloworld/cubit/all_products/all_products_cubit.dart';
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
                ...
                Row(
                  children: [
                    ...
                    IconButton(
                      ...
                      icon: const Icon(Icons.search, color: Color(0xff53B0A2)),
                    ),
                  ],
                ),
              ],
            ...
            InkWell(
              onTap: ()async {
                Response userInfo = await Requests().SearchCustomer(search_query: "?id=${data[0][0]}") as Response;

                Navigator.pushNamed(context, '/userProfile',
                    arguments:[
                      userInfo.data[0]['first_name'],
                      userInfo.data[0]['last_name'],
                      userInfo.data[0]['phone_number'],
                    ]);
